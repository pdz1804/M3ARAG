...
print("📦 Loading ColQwen2 model in INT4 mode with BitsAndBytes...")
...
queries = [
    ...
    # --- MDocAgent-related ---
    "Which modules are part of the MDocAgent multi-agent system?",
    "How does MDocAgent handle document multimodal content?",
    "Which agents in MDocAgent are responsible for vision processing?",
    "Can you show the collaboration pattern of agents in MDocAgent?",
    "Where is the RAG pipeline used in MDocAgent's workflow?",

    # --- Multi-agent collaboration mechanisms ---
    "What are the current trends in collaborative multi-agent LLM systems?",
    "How do agents communicate and resolve conflicts in modern frameworks?",
    "Are there visual cues about task planning among AI agents in these figures?",
    "How is tool-calling orchestrated across agents in recent multi-agent setups?",
    "Can we identify agent roles and responsibilities in this multi-agent architecture?",
]
