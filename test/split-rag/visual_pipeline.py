...
class VisualRAGPipeline:
    ...
    def encode_image(self, pil_image):
        """
        Encodes a PIL Image into base64 JPEG format.

        Useful for frontend visualization, API response packaging, or lightweight storage.

        Args:
            pil_image (PIL.Image): Image to be encoded.
